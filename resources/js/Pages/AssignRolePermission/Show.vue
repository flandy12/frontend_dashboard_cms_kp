...
<template>
    <MasterLayout :url="props.url">
        <div class="container mx-auto">
            ...
            <div
                class="w-full h-[550px] overflow-auto relative overflow-x-auto shadow-md sm:rounded-lg mb-10"
            >
                <table
                    class="w-full h-[550px] relative text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400"
                >
                    <thead
                        class="text-xs text-gray-700 uppercase bg-gray-50 sticky top-0 border"
                    >
                        <tr>
                            <th class="px-6 py-3 border border-gray-200">No</th>
                            <th class="px-6 py-3 border border-gray-200">
                                Name
                            </th>
                            <th class="px-6 py-3 border border-gray-200">
                                Email
                    ...
                    <tbody class="text-gray-600">
                        ...
                        >
                            <td
                                class="w-4 p-4 border border-gray-200 text-center"
                            >
                                {{ key + 1 }}
                            </td>
                            <td
                                class="px-6 py-4 capitalize border border-gray-200"
                            >
                                {{ user.name }}
                            </td>
                            ...
                            <td
                                class="px-6 py-4 border border-gray-200 text-center"
                            >
                                <button
                                    @click="actionClickEdit(user.id)"
            ...
            <Modal
                :show="isModalOpenGiveRole"
                @close="isModalOpenGiveRole = false"
            >
                <!-- Main modal -->
                <div id="">
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative rounded-lg shadow-sm">
                            ...
                            >
                                ...
                                <button
                                    ...
                                    class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"
                                    data-modal-hide="default-modal"
                                    @click="isModalOpenGiveRole = false"
                                >
                                    <svg
                                        class="w-3 h-3"
                                        aria-hidden="true"
                            ...
                            <div class="p-4 md:p-5 space-y-4">
                                <form
                                    class=""
                                    @submit.prevent="submitFormGiveRole"
                                >
                                    <div class="mb-5">
                                        <label
                                            for="base-input"
