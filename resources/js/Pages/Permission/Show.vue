                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div class="pb-4 flex justify-between items-center">
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <input type="text" id="table-search" class="w-52 block pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search for permission">
                            </div>
                        </div>
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody class="text-gray-600">
                            <tr class="bg-white border-b border-gray-200 hover:bg-gray-50" v-for="item in data" :key="item.id">
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
